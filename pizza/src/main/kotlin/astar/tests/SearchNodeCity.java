...
public class SearchNodeCity extends ASearchNode{
    ...
    public double h() {
        if ("Saarbrücken".equals(this.name)) {
            return 222;
        } else if ("Kaiserslautern".equals(this.name)) {
            return 158;
        } else if ("Karlsruhe".equals(this.name)) {
            return 140;
        } else if ("Frankfurt".equals(this.name)) {
            return 96;
        } else if ("Ludwigshafen".equals(this.name)) {
            return 108;
        } else if ("Heilbronn".equals(this.name)) {
            return 87;
        } else if ("Würzburg".equals(this.name)) {
            return 0;
        }
        return 0;
    }
